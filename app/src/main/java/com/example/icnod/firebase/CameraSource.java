package com.example.icnod.firebase;// Copyright 2018 Google LLC
//
...
//
//
// This file was heavily modified by Andres Cruz on October 10, 2019
// Most non-essential features were stripped from this file
...
import com.example.icnod.MainActivity;
...
public class CameraSource {
    ...
    public synchronized void stop() {
        ...
        if (camera != null) {
            ...
            try {
                ...
                System.out.println("[P6_528] Failed to clear camera preview: " + e);
            }
            camera.release();
            camera = null;
        }
    ...
    private class CameraPreviewCallback implements Camera.PreviewCallback {
        ...
        public void onPreviewFrame(byte[] data, Camera camera) {
            ...
            byte[] converted = convertPreviewFrame(data);
            Bitmap bitmap = flipImage(BitmapFactory.decodeByteArray(converted, 0, converted.length));
            mainActivity.getCameraPreview().drawBitmap(bitmap);
        }
